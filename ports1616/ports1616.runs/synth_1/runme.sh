...
HD_PWD='D:/vhdl/ports1616/ports1616.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log port16.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source port16.tcl
